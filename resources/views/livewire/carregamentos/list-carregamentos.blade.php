<div>
    <div class="border mb-5 bg-white p-4 pb-10 pt-6">
        ...
        <div class="grid grid-cols-6">
            ...
            <div class="grid col-span-3 px-4 mt-4 sm:col-span-1 sm:mt-0">
            ...
            <div class="grid col-span-2 px-4 mt-4 sm:col-span-1 sm:mt-0">
            ...
            <div class="grid col-span-4 px-4 mt-4 sm:col-span-1 sm:mt-0">
